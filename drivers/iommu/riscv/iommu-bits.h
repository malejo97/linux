...
#define RISCV_IOMMU_QUEUE_SIZE_FIELD	GENMASK(4, 0)	/* As LOG2(size) - 1 */
#define RISCV_IOMMU_QUEUE_INDEX_FIELD	GENMASK(31, 0)
...
#define RISCV_IOMMU_CAP_VERSION		GENMASK(7, 0)
...
#define RISCV_IOMMU_CAP_IGS		GENMASK(29, 28)
#define RISCV_IOMMU_CAP_HPM		BIT_ULL(30)
#define RISCV_IOMMU_CAP_DBG		BIT_ULL(31)
#define RISCV_IOMMU_CAP_PAS		GENMASK(37, 32)
...
#define RISCV_IOMMU_DDTP_MODE		GENMASK(3, 0)
...
#define RISCV_IOMMU_IOHPMCYCLES_COUNTER	GENMASK(62, 0)
...
#define RISCV_IOMMU_IOHPMEVT_EVENT_ID	GENMASK(14, 0)
#define RISCV_IOMMU_IOHPMEVT_DMASK	BIT_ULL(15)
#define RISCV_IOMMU_IOHPMEVT_PID_PSCID	GENMASK(35, 16)
#define RISCV_IOMMU_IOHPMEVT_DID_GSCID	GENMASK(59, 36)
#define RISCV_IOMMU_IOHPMEVT_PV_PSCV	BIT_ULL(60)
#define RISCV_IOMMU_IOHPMEVT_DV_GSCV	BIT_ULL(61)
#define RISCV_IOMMU_IOHPMEVT_IDT	BIT_ULL(62)
#define RISCV_IOMMU_IOHPMEVT_OF		BIT_ULL(63)

#define RISCV_IOMMU_EVENT_UT_REQ		0x1ULL
#define RISCV_IOMMU_EVENT_TLB_MISS		0x4ULL
#define RISCV_IOMMU_EVENT_DDTW			0x5ULL
#define RISCV_IOMMU_EVENT_S1_PTW		0x7ULL
#define RISCV_IOMMU_EVENT_S2_PTW		0x8ULL
...
#define RISCV_IOMMU_TR_REQ_CTL_PID	GENMASK(31, 12)
#define RISCV_IOMMU_TR_REQ_CTL_PV	BIT_ULL(32)
#define RISCV_IOMMU_TR_REQ_CTL_DID	GENMASK(63, 40)

/* 5.26 Translation request response (64bits) */
#define RISCV_IOMMU_REG_TR_RESPONSE	0x0268
#define RISCV_IOMMU_TR_RESPONSE_FAULT	BIT_ULL(0)
#define RISCV_IOMMU_TR_RESPONSE_PBMT	GENMASK(8, 7)
...
#define RISCV_IOMMU_MSI_ADDR		GENMASK(55, 2)
#define RISCV_IOMMU_REG_MSI_DATA(_n)	(RISCV_IOMMU_REG_MSI_CONFIG + (_n * 0x10) + 0x08)
#define RISCV_IOMMU_MSI_DATA		GENMASK(31, 0)
...
#define RISCV_IOMMU_DC_IOHGATP_PPN	GENMASK(43, 0)
#define RISCV_IOMMU_DC_IOHGATP_GSCID	GENMASK(59, 44)
#define RISCV_IOMMU_DC_IOHGATP_MODE	GENMASK(63, 60)
...
#define RISCV_IOMMU_DC_TA_PSCID		GENMASK(31,12)

/* First-stage context fields */
#define RISCV_IOMMU_DC_FSC_PPN		GENMASK(43, 0)
#define RISCV_IOMMU_DC_FSC_MODE		GENMASK(63, 60)
...
/* MSI address mask */
#define RISCV_IOMMU_DC_MSI_ADDR_MASK	GENMASK(51, 0)
...
#define RISCV_IOMMU_PC_TA_PSCID	GENMASK(31, 12)
...
#define RISCV_IOMMU_CMD_OPCODE	GENMASK(6, 0)
#define	RISCV_IOMMU_CMD_FUNC	GENMASK(9, 7)
...
#define RISCV_IOMMU_CMD_IOTINVAL_PSCID		GENMASK(31, 12)
#define RISCV_IOMMU_CMD_IOTINVAL_PSCV		BIT_ULL(32)
#define RISCV_IOMMU_CMD_IOTINVAL_GV		BIT_ULL(33)
#define RISCV_IOMMU_CMD_IOTINVAL_GSCID		GENMASK(59, 44)
...
#define RISCV_IOMMU_CMD_IOFENCE_DATA		GENMASK(63, 32)
...
#define RISCV_IOMMU_CMD_IODIR_PID		GENMASK(31, 12)
#define RISCV_IOMMU_CMD_IODIR_DV		BIT_ULL(33)
#define RISCV_IOMMU_CMD_IODIR_DID		GENMASK(63, 40)
...
#define RISCV_IOMMU_CMD_ATS_PID			GENMASK(31, 12)
#define RISCV_IOMMU_CMD_ATS_PV			BIT_ULL(32)
#define RISCV_IOMMU_CMD_ATS_DSV			BIT_ULL(33)
#define RISCV_IOMMU_CMD_ATS_RID			GENMASK(55, 40)
#define RISCV_IOMMU_CMD_ATS_DSEG		GENMASK(63, 56)
...
#define RISCV_IOMMU_CMD_ATS_INVAL_UADDR		GENMASK(63, 12)

/* ATS.PRGR payload */
/* Bits 0 - 31 are zeroed */
#define RISCV_IOMMU_CMD_ATS_PRGR_PRG_INDEX	GENMASK(40, 32)
...
/* Fields on header */
#define RISCV_IOMMU_FQ_HDR_CAUSE	GENMASK(11, 0)
#define RISCV_IOMMU_FQ_HDR_PID		GENMASK(31, 12)
#define RISCV_IOMMU_FQ_HDR_PV		BIT_ULL(32)
#define RISCV_IOMMU_FQ_HDR_PRIV		BIT_ULL(33)
#define RISCV_IOMMU_FQ_HDR_TTYPE	GENMASK(39, 34)
#define RISCV_IOMMU_FQ_HDR_DID		GENMASK(63, 40)
...
/* Header fields */
#define RISCV_IOMMU_PREQ_HDR_PID	GENMASK(31, 12)
#define RISCV_IOMMU_PREQ_HDR_PV		BIT_ULL(32)
#define RISCV_IOMMU_PREQ_HDR_PRIV	BIT_ULL(33)
#define RISCV_IOMMU_PREQ_HDR_EXEC	BIT_ULL(34)
#define RISCV_IOMMU_PREQ_HDR_DID	GENMASK(63, 40)

/* Payload fields */
#define RISCV_IOMMU_PREQ_PAYLOAD_R	BIT_ULL(0)
#define RISCV_IOMMU_PREQ_PAYLOAD_W	BIT_ULL(1)
#define RISCV_IOMMU_PREQ_PAYLOAD_L	BIT_ULL(2)
#define RISCV_IOMMU_PREQ_PAYLOAD_M	GENMASK(2, 0)	/* Mask of RWL for convenience */
